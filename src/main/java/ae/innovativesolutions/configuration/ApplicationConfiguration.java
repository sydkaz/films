...
@Configuration
@Lazy
@ComponentScan(basePackages = { "ae.innovativesolutions.services",
        ...
        ,"ae.innovativesolutions.repositoriy","ae.innovativesolutions.components","ae.innovativesolutions.mockdb"})
